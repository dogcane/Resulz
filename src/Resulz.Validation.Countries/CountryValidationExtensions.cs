...
{
    public static ValueChecker<string?> ValidateVatNumber(ValueChecker<string?> checker, string country)
    ...
    public static ValueChecker<string?> ValidateVatRecipientCode(ValueChecker<string?> checker, string country)
        => ValidateVatRecipientCode(checker, country, string.Format("{0}_NOT_VATRECIPIENTCODE", checker.Context).ToUpper());

    public static ValueChecker<string?> ValidateVatRecipientCode(ValueChecker<string?> checker, string country, string message)
    {
